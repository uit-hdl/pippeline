...
path_outl <- file.path(params$path, paste0('outliers', '-', params$experiment, '-', params$ts))
path_report <- file.path(params$path, paste0('report-outliers', '-', params$experiment, '-', params$ts))
